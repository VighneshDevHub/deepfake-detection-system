...
export default function DetectAudioPage() {
  return (
    <div className="flex flex-col gap-10">
      <header>
        ...
        >
          AUDIO <span className="text-primary">DETECTION</span>
        </motion.h1>
      </header>
      ...
      <div className="flex min-h-[600px] flex-col items-center justify-center rounded-[3rem] border border-white/5 bg-white/2 backdrop-blur-3xl text-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-4">HEAR THE <span className="text-primary">UNHEARD</span></h2>
          <p className="max-w-md text-sm font-medium text-zinc-500 uppercase tracking-widest leading-relaxed mb-10">
            We are currently training our neural models to detect synthetic voice cloning and AI-generated audio artifacts. Stay tuned for the most advanced audio forensic engine.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-2xl mb-12">
            {[
              { label: "Voice Cloning", status: "Training" },
              { label: "Artifact Scan", status: "Testing" },
              { label: "Speech Analysis", status: "Dev" },
            ].map((feature) => (
        ...
        <div className="mt-12 flex gap-4 z-10">
          <div className="flex items-center gap-2 rounded-full bg-white/5 px-4 py-2 border border-white/5">
            ...
            <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">ETA: Q3 2026</span>
          </div>
        </div>
      </div>
    </div>
